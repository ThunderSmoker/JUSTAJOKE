...
vars = IntVar()
Radiobutton(master, text="Male", fg='blue', padx=5, variable=vars,
...
list_of_cntry = ['Maharashtra', 'Gujarat',
                 'Madhya Pradesh', 'Assam', 'Jammu and Kashmir']
cv = StringVar()
